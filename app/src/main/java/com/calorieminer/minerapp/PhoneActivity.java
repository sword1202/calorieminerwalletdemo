...
public class PhoneActivity extends AppCompatActivity implements
        ...
        switch (uiState) {
            ...
            case STATE_VERIFY_SUCCESS:
                ...
                disableViews(mStartButton, mVerifyButton, mResendButton, mPhoneNumberField,
                        mVerificationField);
                mDetailText.setText(R.string.success_verification);
                mDetailText.setTextColor(Color.parseColor("#43a047"));
                progressBar.setVisibility(View.INVISIBLE);
    ...
    {
        if (RemoteConfigParam.getInstance(PhoneActivity.this).getMap_location_enabled())
            startActivity(new Intent(this, Hallfinder.class));
        else
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.button_start_verification:
                ...
                CameraActivity.phoneNumber = mPhoneNumberField.getText().toString();
